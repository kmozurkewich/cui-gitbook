 ...
 * May require ```sudo```
* Once Bower and Yeoman are installed, clone this git repository: [https://github.com/thirdwavellc/cui-ng-yeoman](https://github.com/thirdwavellc/cui-ng-yeoman) using your prefered method (HTTP, SSH, or Subversion as prompted by GitHut)
